  ...
  return (
    <div className="page teams-page">
      <header className="page-header">
        <h1>Teams</h1>
        <p className="page-sub">Invite people and review clock times by day. Export roster CSV for the selected date.</p>
      </header>

      <TeamInviteSection />

      <div className="card wide teams-roster-card">
        <h2 className="card-title">Day roster</h2>
